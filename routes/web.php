...
Route::middleware('auth')->group(function () {
    Route::resource('jobs.application', JobApplicationController::class)->only([
        'create',
        // 'show',
        'store',
    ]);
    ...
    // Route::get('my-jobs/{application}', [JobApplicationController::class, 'download'])
    //     ->name('jobs.application.download');
