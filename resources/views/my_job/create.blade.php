        ...
        <form action="{{ route('my-jobs.store') }}" method="POST">
            ...
            <div class="grid mb-4 grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :all-option="false" :value="old('experience')" :options="array_combine(
                ...
                <div>
                    ...
                    <x-radio-group name="category" :all-option="false" :options="\App\Models\Job::$category" :value="old('category')" />
                </div>
                <div class="col-span-2">
